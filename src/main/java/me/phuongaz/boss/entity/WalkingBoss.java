...
import me.phuongaz.boss.utils.Utils;
import org.apache.commons.math3.util.FastMath;

import java.util.Map;

public class WalkingBoss extends BossEntity{

    public WalkingBoss(FullChunk chunk, CompoundTag nbt, Map<String, Float> abt) {
        super(chunk, nbt);
        setMaxHealth(abt.get("health").intValue());
        setMovementSpeed(abt.get("speed"));
        setScale(abt.get("scale"));
